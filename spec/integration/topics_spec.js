...
// COPY AND PASTE THE OLD TESTS HERE
    describe("GET /topics", () => { it("should respond with all topics", (done) => {
    ...
    describe("GET /topics/:id", () => { it("should render a view with the selected topic", (done) => {
...
// COPY AND PASTE THE OLD TESTS HERE
    ...
    describe("POST /topics/create", () => {  const options = {
        url: `${base}create`,
        form: {
          title: "blink-182 songs",
          description: "What's your favorite blink-182 song?"
  ...
  it("should render a new topic form", () => {
  request.get(`${base}new`, (err, res, body) => {
    expect(err).toBeNull();
    expect(body).toContain("New Topic");
    done();
